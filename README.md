...
- Extracting financial data – historical share prices and quarterly revenue reports from various sources.

- Data cleaning and preprocessing – ensuring data quality for accurate analysis.

- Visualization – building dashboards using Python libraries to identify patterns, trends, and insights.

- Decision support – enabling better investment decisions based on data-driven insights.
...
- Historical stock price trends for each company.
- Quarterly revenue comparisons over time.
...
- Data Analysis – using Pandas and NumPy for cleaning, manipulation, and computation.
...
- BeautifulSoup – web scraping HTML data
- yfinance – fetching historical stock prices
- Plotly, Matplotlib – visualization and dashboards
- GitHub – version control and repository management
- IBM Watson Studio / Skills Network Labs – sandbox environment for running notebooks


## IBM-DataScience-Stock-Project/
│── Web_Scraping_Lab.ipynb
│── Extracting_Stock_Data_Python.ipynb
